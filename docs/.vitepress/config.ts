...
export default defineConfig({
  ...
  cleanUrls: true,
  lastUpdated: true,
  // Windows: bind IPv4 so http://127.0.0.1 and localhost both work
  vite: {
    server: {
      host: '127.0.0.1',
      port: 5277,
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: `版本 ${pkg.version}`, link: 'https://github.com/keen2y/done-mail/releases' }
    ],
    sidebar: [
      {
        text: 'DoneMail简介',
        ...
        items: [
          ...
          { text: '更新日志', link: 'https://github.com/keen2y/done-mail/releases' }
        ]
      },
      {
        text: '部署与配置',
    ...
    socialLinks: [{ icon: 'github', link: 'https://github.com/keen2y/done-mail' }],
    editLink: {
      pattern: 'https://github.com/keen2y/done-mail/edit/main/docs/:path',

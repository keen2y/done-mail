...
(
  'preview_mail_1',
  '{"from":"L chily <lchily@hotmail.com>","to":"hi@poki.dpdns.org"}',
...
(
  'preview_mail_2',
  '{"from":"Example Notice <notice@example.com>","to":"hi@poki.dpdns.org"}',
  '第二封邮件用于测试共享账户列表的行距、标题截断和详情抽屉。',
...
(
  'preview_mail_3',
  '{"from":"Billing Team <billing@example.net>","to":"test@poki.dpdns.org"}',
  '这封邮件用于让后台共享账户列表看起来更接近真实数据。',
